    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Accounts2',
            fields=[
                ...
                ('org_type', models.CharField(blank=True, default='', max_length=300, null=True)),
                ('a_number', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.SET_NULL, to='customer_segmentation.accounts1')),
            ],
        ),
    ]
