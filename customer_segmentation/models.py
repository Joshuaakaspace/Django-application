...
class Accounts2(models.Model):
    org_type= models.CharField(max_length=300, null=True, blank=True, default="")
    a_number = models.ForeignKey(Accounts1, on_delete=models.SET_NULL, null=True, blank=True, default="")
    def __str__(self):
        return self.a_number.a_number
